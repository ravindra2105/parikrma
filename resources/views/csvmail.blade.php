			...
			<body style="margin:0px; padding:0px; font-family: Lato, sans-serif;">
				<table width="624" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
					...
					<tr style="background:#f7f7f7;">
						<td colspan="2" style="padding-left:15px;padding-right:15px;padding-bottom:25px; font-size:14px; line-height:24px; color:#242424;">
							<br>
							<br>Dear, 
							<br>Welcome, please see below message.
							<br>
